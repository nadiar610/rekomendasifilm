    ...
    <section class="gallery">
      <div class="Drama" id="drama">
        ...
        <div class="gallery-container">
          ...
          <div class="gallery-item">
            <img src="img/vincenzo.jpg" alt="Film Poster 1" />
            <div class="overlay">
              <h4>A Shop for Killers</h4>
              <p>Thriller | Episode 1</p>
            </div>
          ...
          <div class="gallery-item">
            <img src="img/dr romantic 2.jpg" alt="Film Poster 1" />
            <div class="overlay">
              <h4>A Shop for Killers</h4>
              <p>Thriller | Episode 1</p>
            </div>
          ...
          <div class="gallery-item">
            <img src="img/dr romantic 3.jpg" alt="Film Poster 1" />
            <div class="overlay">
              <h4>A Shop for Killers</h4>
              <p>Thriller | Episode 1</p>
            </div>
      ...
      <div class="sekolah" id="sekolah">
        ...
        <div class="gallery-container">
          ...
          <div class="gallery-item">
            <img
              src="img/weightlifting fairy kimbookjoo.jpg"
              alt="Film Poster 1"
            />
            <div class="overlay">
              <h4>A Shop for Killers</h4>
      ...
      <div class="romance" id="romance">
        ...
        <div class="gallery-container" id="Drama">
          <div class="gallery-item">
            <img src="img/hometown cha cha cha.jpg" alt="Film Poster 1" />
            <div class="overlay">
              <h4>A Shop for Killers</h4>
              <p>Thriller | Episode 1</p>
            </div>
